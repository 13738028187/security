...
*/            theta: 0.8,  // 限制计算时间
            ...
            prepareData: function(graph) {
                ...
                for(var i = 0; i < nodes_length; i++) {
                    // 计算节点有多少连接
                    nodes[i].linkCount = 0;
                    nodesMap[nodes[i].label] = i;
                }
                for(var c = 0; c < links_length; c++) {
                    var sourceIndex = nodesMap[links[c].source.label],
                    targetIndex = nodesMap[links[c].target.label];
                    // 确保源和目标存在
                    if(!nodes[sourceIndex]) { throw("source '" + links[c].source.label + "' not found"); }
                    if(!nodes[targetIndex]) { throw("target '" + links[c].target.label + "' not found"); }
                    links[c].source = nodesMap[links[c].source.label];
                    links[c].target = nodesMap[links[c].target.label];
                    // 将链接计数添加到两端
         ...
         // TODO: node
            ...
            onClickNode: function(n) {
            	...
            	$("svg").remove(); 
            	console.log(n);
            	/*d3.fixNetJsonGraph("net2.json");*/
            	if(n.ip=="192.168.1.2"){
            		d3.fixNetJsonGraph("../resources/json/net1.json");
            	}else if(n.ip=="192.168.2.1"){
            		d3.fixNetJsonGraph("../resources/json/net2.json");
            	}else{
            		d3.fixNetJsonGraph("../resources/json/net.json");
            	}  
            },
         // TODO: link
            /**
            ...
            processJson = function(graph) {
                ...
                var link = panner.selectAll(".link")
                    ...
                    .attr('xlink:href',function(node){  
                     if(node.type==-1){
                    	return "data:image/png;base64,";
                    	}else if(node.type==2){
