...
public class UserDefinedMODBUS {

	private Integer userDefinedMODBUSId;
	...
	public Integer getUserDefinedMODBUSId() {
		return userDefinedMODBUSId;
	}

	public void setUserDefinedMODBUSId(Integer userDefinedMODBUSId) {
		this.userDefinedMODBUSId = userDefinedMODBUSId;
	}
	...
	public String toString() {
		return "UserDefinedMODBUS [userDefinedMODBUSId=" + userDefinedMODBUSId + ", ruleName=" + ruleName
				+ ", originIP=" + originIP + ", goalIP=" + goalIP + ", originIPmac=" + originIPmac + ", goalIPmac="
				+ goalIPmac + ", functionCode=" + functionCode + ", initialAddr=" + initialAddr + ", endAddr=" + endAddr
				+ ", protocol=" + protocol + "]";
	}
